...
SELECT	sv_id,
        ...
        sv_sortorder
FROM	services_tb
WHERE	sv_inactive = 0 AND
		sv_deleted = 0 
ORDER BY	sv_sortorder ASC
</cfquery>
<!-- InstanceEndEditable -->
<body>
...
<cfoutput query="ListPageCopy">#pc_pagetext#</cfoutput>
  ...
  <div class="theListHeader">Areas of practice</div>
          <ul class="thePracList">
            
                <cfoutput query="ThePractice">
              <li><a href="Practice-Details.cfm?thePracID=#sv_id#">#sv_title#</a></li>
            </cfoutput>
            </ul>
